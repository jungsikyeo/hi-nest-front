  ...
  return (
    <div className="w-full h-screen bg-black">
      ...
      <div className="w-full relative">
        ...
        <div>
          <main
            className="relative w-full flex flex-col items-center max-h-full bg-gradient-to-b from-red-400 to-yellow-400"
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="w-full px-5 pt-8 flex text-sm text-white">
                <span>
                  ...
                  <p>
                    최근 Spotify 사이트가 국내 버전으로 오픈되어, 제 우버이츠
                    챌린지 졸업 작품의 모티브가 되었습니다.
                  </p>
                  <br />
                  <p>
                    Host 권한으로 가입하면 Spotify API 를 이용하여 자신만의
                    자신만의 플레이리스트를 만들 수 있습니다.
                  </p>
                  <p>
                    Listener 권한으로 가입하면 Host가 만든 플레이리스트를
                    구독하고 음악을 청취할 수 있습니다.
                  </p>
                </span>
              </div>
