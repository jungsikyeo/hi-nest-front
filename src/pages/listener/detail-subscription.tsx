...
export const DetailSubscription = (props: any) => {
  ...
  const notifyInfo = (notifyMessage: any) => {
  ...
  const notifySuccess = (notifyMessage: any) => {
  ...
  const notifyError = (notifyMessage: any) => {
        ...
        <div className="w-full">
          <div className="flex flex-col">
            {podcast?.episodes.length > 0 ? (
              ...
              <section className="h-15 text-2xl text-white font-medium py-2 mt-5">
                <div className="flex">
                  <div
